...
<div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
        ...
        <p class="lead">Rastreio e controle de encomendas em tempo real, totalmente automatizado.
...
<div class="container3 row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class=" text3 col-lg-6">
        <h1 class=" title3 display-4 fw-bold lh-1 mb-3">Benefécios para você</h1>
